...
return new class extends Migration
{
    ...
    {
        Schema::create('partner_pricings', function (Blueprint $table) {
            $table->id(); // Primary key
            $table->foreignId('voucher_profile_id')->constrained('voucher_profiles')->onDelete('cascade'); // Foreign key to VoucherProfile
            $table->string('partner_type'); // Type of partner (e.g., "Mitra Wilzio Saller", "Mitra Wilzio Partner")
            ...
            $table->decimal('partner_profit', 10, 2)->default(0); // Partner profit
