...
//import component slider
import WalletProfile from '../../../Shared/WalletProfile';
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-8">
                                ...
                                <div className="row justify-content-between mb-3 mt-4">
                                    <div className="col-md-6 col-6 text-start"><strong> Flash Sale</strong></div>
                                    <div className="col-md-6 col-6 text-end">
                                        <Link href="/products" className="text-dark"><strong>Lihat Semua <i className="fa fa-long-arrow-alt-right"></i></strong></Link>
                                    </div>
                                </div>
